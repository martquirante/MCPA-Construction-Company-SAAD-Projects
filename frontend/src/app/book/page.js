      ...
      <header className="border-b border-neutral-200 dark:border-white/10 bg-white/85 dark:bg-black/60 backdrop-blur-md sticky top-0 z-40 px-4 sm:px-8 py-4 transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-xs font-mono tracking-wider uppercase text-neutral-600 dark:text-neutral-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors px-3 py-1.5 rounded-lg border border-neutral-300 dark:border-white/10 hover:border-amber-500/40"
            >
...
export default function BookPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#f8f7f5] dark:bg-neutral-950 flex items-center justify-center text-amber-500 font-mono">Loading Booking Engine...</div>}>
      <BookingContent />
    </Suspense>
  );
}
